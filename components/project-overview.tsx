...
export const ProjectOverview = () => {
  return (
    <div className="flex flex-col items-center justify-end">
      <h1 className="text-3xl font-semibold mb-4">Captain Jays AI Guidelines Chatbot</h1>
      <p className="text-center">
        This project is still in [WIP] using <Link href="https://deepinfra.com/">DeepInfra.</Link>{" "}
